...
{
    public abstract class MenuWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MenuWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MenuWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MenuDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MenuDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MenuDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MenuDbContext, Task<T>> func)
        {
            T result;
